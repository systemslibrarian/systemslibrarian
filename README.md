...
|---|---|
| ❄️ **[SNOW2](https://github.com/systemslibrarian/snow2)** **[Live Demo](https://systemslibrarian.github.io/snow2/)** | A modern Rust reimplementation inspired by Matthew Kwan's classic SNOW tool, hiding authenticated encrypted payloads inside ordinary-looking text using whitespace steganography. Uses XChaCha20-Poly1305, Argon2id + HKDF, hardened extraction bounds, secure-memory handling, and optional post-quantum support. |
| 🔐 **[TruePad](https://github.com/systemslibrarian/TruePad)** **[Browser Edition](https://systemslibrarian.github.io/TruePad/)** | A cross-platform educational one-time-pad system focused on the engineering problem OTPs usually omit: keeping pad material single-use across crashes, stale copies, restores, two-party state, authentication, and delivery. Uses OTP encryption with one-time Wegman–Carter authentication. |
| 🔳 **[HideAndSeen](https://github.com/systemslibrarian/HideAndSeen)** **[Live Demo](https://systemslibrarian.github.io/HideAndSeen/)** | An interactive QR-code steganography and forensics laboratory exploring what can exist inside a valid QR symbol beyond what ordinary scanners return. Fourteen research-backed exhibits cover padding and segmentation channels, error-correction hiding, visual secret sharing, dual-message QR codes, encoder fingerprints, steganalysis, and detection limits. |
...
| 4 | <img src="https://cybersecurity-excellence-awards.com/wp-content/uploads/cybersecurity_awards_2026_gold.png" alt="Gold Winner" width="20"> **[Crypto Lab](https://crypto-lab.systemslibrarian.dev/)** · [repo](https://github.com/systemslibrarian/crypto-lab) · [2026 Cybersecurity Excellence Awards — Gold Winner](https://cybersecurity-excellence-awards.com/candidates/crypto-lab-2026/) | **Experiment deeply.** 190+ browser-based demos — post-quantum cryptography, ZK proofs, homomorphic encryption, MPC, threshold schemes, attacks, and steganography. Browser-constrained. Educational by design. No accounts. Just the math. |
...
**Current scale:** 54+ published NuGet packages · 100K+ total downloads  
...
**Cryptography Education** — crypto-lab (190+ browser demos) · Cipher Museum (140 exhibits) · crypto-compare (97 algorithms across 17 categories) · real-primitive demos · KNOWN-GAPS documentation
