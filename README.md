...
| **Frameworks & Runtimes** | `.NET 8`, `ASP.NET Core MVC`, `Next.js`, `FastAPI` |
| **AI / ML** | `Prompt Engineering`, `LangChain`, `OpenAI API`, `Google AI Platform`, `Multi-Agent Systems`, `LLM Orchestration` |
| **Data & Engineering** | `Data Pipelines`, `Pandas`, `Visualization`, `Automation`, `APIs`, `WASM`, `Async Systems`, `CI/CD`, `Observability` |
