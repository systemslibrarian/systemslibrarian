...
| 🔐 **[TruePad]** [Browser Edition](https://systemslibrarian.github.io/TruePad/)| A cross-platform educational one-time-pad system focused on the engineering problem OTPs usually omit: keeping pad material single-use across crashes, stale copies, restores, two-party state, authentication, and delivery. Uses OTP encryption with one-time Wegman–Carter authentication. |
...
| **Intercede** | [**Prayer Sealed**](https://prayerwarriors.mobi)<br>*Prayer Sealed Ministries (future nonprofit) * | **Because Prayer Can’t Wait™** — private, end-to-end encrypted prayer for Android and iOS, built on post-quantum cryptography (X-Wing hybrid KEM, ML-DSA-65, AES-256-GCM). Private prayers, prayer partners, prayer groups, and recovery designed so your prayers stay yours — sealed on your device, unreadable to the server. |
